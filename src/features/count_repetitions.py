...
def count_reps(dataset, cutoff = 0.4, order = 10, column = "acc_r"):
    """
    Count the number of repetitions in a dataset.
    """
...
error = mean_absolute_error(rep_df["reps"], rep_df["pred_reps"])
#print(error) error: 1.02(which is good)
rep_df.groupby(["label", "category"])[["reps", "pred_reps"]].mean().plot.bar()
#plt.show()
plt.savefig("reports/Result/result.png")